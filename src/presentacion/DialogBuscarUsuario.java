...
public class DialogBuscarUsuario extends javax.swing.JDialog {
    ...
    private void txtNombreKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreKeyReleased
        ...
        try {
            UsuarioDAO.getInstancia().mostrarPorNombre(nombre, modelo);
    ...
    private void btnTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTodosActionPerformed
        try {
            UsuarioDAO.getInstancia().mostrarUsuarios(modelo);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null,ex.getMessage());
        }
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        if(i!=-1)
        {
          usuarioSelec.setIdusuario(modelo.getValueAt(i, 0).toString());
          usuarioSelec.setNombre(modelo.getValueAt(i, 1).toString());
          usuarioSelec.setTelefono(modelo.getValueAt(i, 2).toString());
          usuarioSelec.setDireccion(modelo.getValueAt(i, 3).toString());
          this.dispose();
        }
        else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogBuscarUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogBuscarUsuario dialog = new DialogBuscarUsuario();
